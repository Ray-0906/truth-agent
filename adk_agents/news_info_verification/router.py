...
def create_content_routing_agent(model: str = MODEL) -> LlmAgent:
    """Create the top-level content routing agent."""
    ...
    return LlmAgent(
        ...
        instruction=(
            ...
            "5. Once all chosen lanes finish, invoke FinalProcessingAgent exactly once using {\"request\": \"summarize\"} to produce the user-facing report.\n"
            "6. Respond to the user with ONLY the Markdown returned from FinalProcessingAgent.\n\n"
            "Guardrails:\n"
